...
JWT_AUTH = {
    "JWT_GET_USER_SECRET_KEY": "snap.authentication.services.auth_user_get_jwt_secret_key",
    "JWT_RESPONSE_PAYLOAD_HANDLER": "snap.authentication.services.auth_jwt_response_payload_handler",
